...
public class GoogleAnalyticsSettingsEditor : Editor {
	...
	private void GeneralOptions() {
		...
		if(settings.UsePlayerSettingsForAppInfo) {
			...
			#if UNITY_ANDROID
			settings.AppVersion = PlayerSettings.bundleVersion + "-" + PlayerSettings.Android.bundleVersionCode;
			#else
			settings.AppVersion = PlayerSettings.bundleVersion + "-" + PlayerSettings.bundleVersion;
			#endif
